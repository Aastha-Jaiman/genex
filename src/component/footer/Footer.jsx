      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-8 md:gap-16">
            ...
            {/* Contact Column */}
            <div>
              <h3 className="text-blue-600 font-semibold mb-3 text-lg">Contact</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:contact@genexgroup.in" className="text-sm text-gray-600 hover:text-blue-600">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+919142442028" className="text-sm text-gray-600 hover:text-blue-600">
                    +91 9142 442028
                  </a>
                </div>
                ...
                <div className="flex space-x-4 pt-2">
                  <a href="https://linkedin.com/company/genex" aria-label="LinkedIn" className="text-blue-600 hover:text-blue-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="https://facebook.com/genexcooling" aria-label="Facebook" className="text-blue-600 hover:text-blue-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com/genexcooling" aria-label="Instagram" className="text-blue-600 hover:text-blue-800">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
