...
const Footer = () => {
  return (
    <footer className="bg-gray-200 border-t border-gray-200 py-8 px-4 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-8 md:gap-16">
            ...
            <div>
              ...
              <li><Link href="/" className="text-gray-600 hover:text-blue-800">Home</Link></li>
                <li><Link href="/contact" className="text-gray-600 hover:text-blue-800">Contact Us</Link></li>
                <li><Link href="/services" className="text-gray-600 hover:text-blue-800">Services</Link></li>
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">Products</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">VRF-VRV</Link></li>
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">Enterprise</Link></li>
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">Foldawater</Link></li>
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">Main Features</Link></li>
                <li><Link href="/products" className="text-gray-600 hover:text-blue-800">Mobile App</Link></li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <address className="text-sm text-gray-600 not-italic">
                    Zerox Provider Center, Om Dewdke Building,<br />
                    Plot No.5, 3rd Floor, University Rd.,<br />
