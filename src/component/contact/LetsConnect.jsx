    ...
    <section className="w-full px-4 py-12 sm:px-6 md:px-16 bg-white text-gray-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-blue-700 mt-2">Let's connect</h2>
        </div>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-6">
            {/* Reach us via */}
            <div>
              <h4 className="text-lg font-semibold text-blue-700 mb-2">Reach us via</h4>
              ...
              <div className="flex gap-3 mt-3 text-blue-700">
            ...
            {/* Business Info */}
            <div>
              <h4 className="text-lg font-semibold text-blue-700 mb-2">Business info</h4>
